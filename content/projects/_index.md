...
{{< /paige/figure >}}
{{< paige/figure caption="[<h4>Financial Machine Learning modeling exercise<h4>](https://github.com/apodl1/financial-ml-modeling-exercise)" >}}
  {{< paige/image class="rounded-1" width="auto" height="auto" maxheight="24rem" maxwidth="100%" process="webp picture x2000 q50" src="ml.png" link="https://github.com/apodl1/financial-ml-modeling-exercise" >}}
{{< /paige/figure >}}
{{< paige/figure caption="[<h4>htmgo authentication template<h4>](https://github.com/apodl1/htmgo-advanced-authentication-example)" >}}
  {{< paige/image class="rounded-1" width="auto" height="auto" maxheight="24rem" maxwidth="100%" process="webp picture x2000 q50" src="htmgo.png" link="https://github.com/apodl1/htmgo-advanced-authentication-example" >}}
{{< /paige/figure >}}

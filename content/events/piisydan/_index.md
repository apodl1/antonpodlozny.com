+++
title = 'Teekkarispeksi 2026 - Piisydän'
+++
    ...
    <div class="justify-content-center row">
        <div class="col col-auto col-lg-7 px-0">
            <p class="lead text-center">
              A student-run musical production with ~2500 annual viewers, 2026 edition</p>
        </div>
    </div>
</div>
<br>
...
<div class="container-fluid">
    <div class="justify-content-center row">
        <div class="col col-auto col-lg-7 px-0">
            <p class="text-center">Photos: Antti Virtanen, Heikki Systä, Lauri Viljavuori & Akseli Konttas</p>
        </div>
    </div>
</div>
<br>
